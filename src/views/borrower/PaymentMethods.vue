...
import PaymentActions from "@/components/borrower/PaymentActions.vue";
import NewCardModal from "@/components/borrower/NewCardModal.vue";
import NewAddressModal from "@/components/borrower/NewAddressModal.vue";

export default defineComponent({
  name: "Payment",
  components: {NewAddressModal, NewCardModal, PaymentActions},
  setup() {
    return {
      getAssetPath,
    };
    ...
    <div class="card-header border-0">
      ...
      <div class="card-toolbar">
        <a
            ...
            data-bs-target="#b_modal_new_card"
        >
          <KTIcon icon-name="credit-cart" icon-class="fs-3" />
          Add new card details</a
        >
        <a
            href="#"
            class="btn btn-sm btn-flex btn-light-primary"
            data-bs-toggle="modal"
            data-bs-target="#b_modal_new_bank"
        >
          <KTIcon icon-name="bank" icon-class="fs-3" />
      ...
      <div class="py-0" data-kt-customer-payment-method="row">
        ...
        <div class="py-3 d-flex flex-stack flex-wrap">
          ...
          >
            ...
            <!--begin::Logo-->
            <img
                :src="getAssetPath('media/svg/payment-methods/td-bank.svg')"
                class="w-40px me-3"
                alt=""
            />
            <!--end::Logo-->
            ...
            <div class="me-3">
              <div class="d-flex align-items-center">
                <div class="text-gray-800 fw-bold">TD Bank</div>
              </div>
