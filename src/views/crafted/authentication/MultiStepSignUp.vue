...
import BorrowerStep2 from "@/components/wizard/steps/BorrowerStep2.vue";
...
export default defineComponent({
  ...
  setup() {
    ...
    const totalSteps = computed(() => {
      console.log('stepperrr', _stepperObj.value);
      return (_stepperObj.value) ? _stepperObj.value!.totalStepsNumber : 0;
      // return 5;
    });
