    ...
    <div class="card-body pt-9 pb-0">
      ...
      <div class="d-flex overflow-auto h-55px">
        ...
        >
          ...
          <li class="nav-item">
            <router-link
              to="/investor/account/profile/overview"
          ...
          <li class="nav-item">
            <router-link
              to="/investor/account/profile/settings"
              class="nav-link text-active-primary me-6"
              active-class="active"
            >
              Settings
          ...
          <li class="nav-item">
            <router-link
              to="/investor/account/profile/documents"
              class="nav-link text-active-primary me-6"
              active-class="active"
            >
              Documents
          ...
          <li class="nav-item">
            <router-link
              to="/investor/account/profile/subscriptions"
              class="nav-link text-active-primary me-6"
              active-class="active"
            >
              Subscriptions
